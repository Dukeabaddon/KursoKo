...
export const HERO_CHARACTER = {
  ...
  height: 830,
  className:
    'pointer-events-none absolute bottom-0 left-1/2 z-20 h-[94%] w-auto max-w-none -translate-x-1/2 object-contain object-bottom select-none md:h-[90%] md:-translate-x-[56%] lg:h-[110%]',
}
