...
export const landingHeroCta =
  'inline-flex items-center justify-center rounded-full border-2 border-white bg-landing-accent px-6 py-2.5 text-sm font-semibold text-white shadow-none transition-transform duration-300 ease-landing hover:scale-105 hover:bg-landing-accent-hover hover:shadow-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-landing-paper active:scale-100 md:px-7 md:py-3 md:text-base'
